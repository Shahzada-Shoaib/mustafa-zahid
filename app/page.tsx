...
export default function Home() {
  ...
  const songs = [
    { title: "Tu Phir Aao", description: "A beautiful romantic melody", year: "2010", image: "mz-pic-3.JPG", youtubeUrl: "https://www.youtube.com/watch?v=XHFn4ofMS5I&list=RDXHFn4ofMS5I&rco=1" },
    { title: "Tera Mera Rishta Purana", description: "A timeless classic", year: "2008", image: "mz-pic-4.JPG", youtubeUrl: "https://www.youtube.com/watch?v=0J0HZrDvbjY&list=RD0J0HZrDvbjY&start_radio=1" },
    { title: "Bhula Dena Mje", description: "An emotional heartfelt song", year: "2005", image: "mz-pic-5.jpg", youtubeUrl: "https://www.youtube.com/watch?v=g8LEktKv9hs&list=RDg8LEktKv9hs&rco=1" },
    { title: "Zarorat", description: "One of the most beloved tracks", year: "2013", image: "mz-pic-6.jpg", youtubeUrl: "https://www.youtube.com/watch?v=VMEXKJbsUmE&list=PLW5kSXGjYPCW9dU2ynegjiNxypWTsO5Fp" },
    { title: "Hum Jee Lenge", description: "A powerful emotional song", year: "2012", image: "mz-pic-7.jpg", youtubeUrl: "https://www.youtube.com/watch?v=WYtmISG_piI&list=PLW5kSXGjYPCW9dU2ynegjiNxypWTsO5Fp&index=12" },
    { title: "Kaisey Jiyen", description: "Soulful and moving composition", year: "2011", image: "mz-pic-10.jpg", youtubeUrl: "https://www.youtube.com/watch?v=0fpAWekduJ8&list=PLW5kSXGjYPCW9dU2ynegjiNxypWTsO5Fp&index=18" },
  ];

  const galleryImages = [
    { src: "/mz-pic-9.jpg", alt: "Mustafa Zahid Portrait - Thoughtful Expression", category: "Portrait" },
    { src: "/mz-pic-10.jpg", alt: "Mustafa Zahid Portrait - Serious Expression", category: "Portrait" },
    { src: "/mz-pic-11.jpg", alt: "Mustafa Zahid in Recording Studio", category: "Studio" },
    { src: "/mz-pic-12.jpg", alt: "Mustafa Zahid Live Performance on Stage", category: "Live" },
    { src: "/Mz-pic.jpg", alt: "Mustafa Zahid Stage Performance with Microphone", category: "Live" },
    { src: "/mz-pic-2.JPG", alt: "Mustafa Zahid Concert Performance", category: "Concert" },
  ];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .animate-music-note { animation: music-note-float 3s ease-in-out infinite; will-change: transform, opacity; }
        .animate-sound-wave { animation: sound-wave 1.5s ease-in-out infinite; will-change: transform, opacity; }
        .animate-rotate-slow { animation: rotate-slow 20s linear infinite; will-change: transform; }
      ...
      <div className="fixed inset-0 z-0 overflow-hidden">
        ...
        {[...Array(8)].map((_, i) => (
          <div
            ...
            aria-hidden="true"
          >
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" className="text-red-500/30" aria-hidden="true">
        ...
        <div className="absolute bottom-20 left-10 flex items-end gap-1 h-20" aria-hidden="true">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
        ...
        <div className="absolute top-32 right-16 flex items-end gap-1 h-16" aria-hidden="true">
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen flex items-center justify-center pt-12 sm:pt-14 md:pt-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pb-12 lg:pb-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            {/* Left Content */}
            <div className={`space-y-6 lg:space-y-8 text-center lg:text-left ${isMounted ? 'animate-slide-in-left' : ''}`}>
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-lg leading-relaxed mx-auto lg:mx-0">
                Oneee of Pakistan&apos;s most celebrated voices, blending soulful melodies with powerful emotions. 
                Book Mustafa Zahid for your events, concerts, and performances.
              </p>
              ...
              {/* Booking Callout */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-600/20 border border-red-500/30 rounded-full text-sm text-white/90 mx-auto lg:mx-0">
                <svg className="w-4 h-4 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span>Available for bookings & events</span>
              </div>
            ...
            {/* Right - Hero Image */}
            <div className={`relative ${isMounted ? 'animate-slide-in-right' : ''}`}>
              <div className="relative w-full aspect-[4/5] max-w-md mx-auto">
                {/* Decorative Elements */}
                <div className="absolute -top-8 -right-8 w-32 h-32 border border-red-500/30 rounded-full animate-rotate-slow" aria-hidden="true"></div>
                <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-gradient-to-br from-red-600/20 to-transparent rounded-full blur-xl" aria-hidden="true"></div>
                
                {/* Animated Vinyl Record */}
                <div className="absolute -top-12 -right-12 w-24 h-24 z-30 animate-rotate-slow" aria-hidden="true">
                ...
                <div className="relative w-full h-full rounded-3xl overflow-hidden animate-pulse-glow">
                  ...
                  <div className="absolute bottom-20 left-4 flex items-end gap-1 h-12 z-20 opacity-60" aria-hidden="true">
                    {[...Array(4)].map((_, i) => (
                      <div
                        key={i}
                ...
                <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 px-6 py-3 glass-card rounded-full flex items-center gap-3 z-20 animate-bounce-in">
                  ...
                  <div>
                    <div className="text-xs text-white/70 uppercase tracking-wider">Now Playing</div>
                    <div className="text-sm font-medium text-white">Bhula Dena</div>
                  </div>
                  {/* Animated Music Note */}
                  <svg 
                ...
                <div className="absolute -top-16 left-1/4 animate-music-note" style={{ animationDelay: '1s' }} aria-hidden="true">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-red-500/40" aria-hidden="true">
                    <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" fill="currentColor"/>
                  </svg>
                </div>
                <div className="absolute -bottom-20 right-1/4 animate-music-note" style={{ animationDelay: '1.5s' }} aria-hidden="true">
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="text-amber-500/40" aria-hidden="true">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="hidden lg:block lg:h-screen lg:sticky lg:top-0">
              <div className="h-full flex items-center py-12 lg:py-16">
            ...
            <div className="py-12 lg:py-16 space-y-8 lg:space-y-12">
              {/* Section Header */}
      ...
      <section id="music" className="relative bg-gradient-to-b from-transparent via-red-950/20 to-transparent overflow-hidden py-12 lg:py-16">
        {/* Animated Sound Waves Background */}
        <div className="absolute top-20 left-10 flex items-end gap-1 h-24 opacity-20" aria-hidden="true">
          {[...Array(7)].map((_, i) => (
            <div
              key={i}
        ...
        <div className="absolute bottom-20 right-16 flex items-end gap-1 h-20 opacity-20" aria-hidden="true">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
        ...
        {/* Floating Music Notes */}
        <div className="absolute top-1/4 right-20 animate-music-note" style={{ animationDelay: '2s' }} aria-hidden="true">
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none" className="text-red-500/20" aria-hidden="true">
            <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" fill="currentColor"/>
          </svg>
        </div>
        ...
        <div className="sticky top-16 z-30 py-6 bg-black/80 backdrop-blur-xl border-y border-white/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div className="flex items-center justify-between">
              ...
              <a href="#music" className="hidden md:flex items-center gap-2 text-white/80 hover:text-red-500 transition-colors">
      ...
      <section id="gallery" className="relative py-12 lg:py-16">
        {/* Sticky Section Header */}
        <div className="sticky top-16 z-30 py-6 bg-black/80 backdrop-blur-xl border-y border-white/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div className="flex items-center justify-between">
      ...
      <section id="contact" className="relative py-12 lg:py-16 overflow-hidden">
        ...
        <div className="absolute top-20 right-20 animate-music-note" style={{ animationDelay: '0.5s' }} aria-hidden="true">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="text-red-500/20" aria-hidden="true">
            <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" fill="currentColor"/>
          </svg>
        </div>
        
        <div className="absolute bottom-32 left-16 animate-music-note" style={{ animationDelay: '1.5s' }} aria-hidden="true">
          <svg width="36" height="36" viewBox="0 0 24 24" fill="none" className="text-amber-500/20" aria-hidden="true">
            <path d="M9 18V5l12-2v13M9 18c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-2" fill="currentColor"/>
          </svg>
        </div>
        
        {/* Sound Waves */}
        <div className="absolute top-1/2 right-10 flex items-end gap-1 h-16 opacity-20" aria-hidden="true">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="w-1.5 bg-red-500 rounded-t animate-sound-wave"
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="space-y-6 lg:space-y-8 animate-slide-in-left">
              ...
              <div className="space-y-4 lg:space-y-6">
                ...
                <a href="tel:+923224071299" className="flex items-center gap-4 p-4 lg:p-6 glass-card rounded-xl hover:bg-white/10 transition-all group">
                  <div className="w-12 h-12 bg-red-600/20 rounded-full flex items-center justify-center group-hover:bg-red-600 transition-colors">
                    <svg className="w-5 h-5 text-red-500 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="glass-card rounded-3xl p-8 lg:p-10 animate-slide-in-right relative overflow-hidden">
              ...
              <div className="absolute -top-8 -right-8 w-32 h-32 opacity-10 animate-rotate-slow" aria-hidden="true">
                <svg viewBox="0 0 100 100" className="w-full h-full text-red-500" aria-hidden="true">
                  <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" strokeWidth="2"/>
      ...
      <button
        ...
        className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-red-600 rounded-full flex items-center justify-center hover:bg-red-500 transition-all transform hover:scale-110 shadow-2xl shadow-red-900/50 ${isMounted && scrollY > 500 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
        }`}
