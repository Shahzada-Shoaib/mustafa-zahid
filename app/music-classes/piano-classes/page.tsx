        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mt-3 mb-8">
                Why Learn <span className="text-gradient">Piano?</span>
              </h2>
                ...
                {[
                  {
                    ...
                    description: "Develops coordination, concentration, and multitasking abilities. Research shows piano players have enhanced memory, better problem-solving skills, and improved spatial-temporal reasoning."
                  },
                  {
                    icon: (
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    title: "Foundation for All Music",
                    description: "The piano is often called the 'universal instrument' because understanding piano helps you understand all music. The linear layout makes music theory concepts visual and easier to grasp."
                  },
                  {
                    icon: (
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    title: "Versatile & Expressive",
                    description: "Can play melody, harmony, and rhythm simultaneously, making it one of the most complete solo instruments. Perfect for both solo performance and accompaniment."
                  }
                ].map((benefit, index) => (
                  <div key={index} className="glass-card rounded-xl p-5 lg:p-6 hover-lift">
